...
from deep_parser.common import rag_tokenizer
from deep_parser.vision import OCR, Recognizer, LayoutRecognizer, TableStructureRecognizer
...
class RAGFlowPdfParser:
    def __init__(self):
        ...
        try:
            model_dir = os.path.join("../res/", "deepdoc_ext")
            ...
            #     local_dir=os.path.join("../res/", "deepdoc_ext"),
